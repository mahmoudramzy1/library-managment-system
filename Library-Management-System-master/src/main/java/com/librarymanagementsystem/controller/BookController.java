...
public class BookController {
	...
	public String createBook(Book book, BindingResult result, Model model) {
		...
		if (book.getDescription() == null || book.getDescription().isEmpty()) {
			model.addAttribute("errorMessage", "Description cannot be empty");
			return "add-book";
		}
		if (book.getIsbn() == null || book.getIsbn().isEmpty()) {
			model.addAttribute("errorMes", "ISBN cannot be empty");
			return "add-book";
		}	else if (!isValidInteger(book.getIsbn())) {
			
			model.addAttribute("errorMessag", "ISBN must be an integer.");
			return "add-book";
		}
		if (book.getSerialName() == null || book.getSerialName().isEmpty()) {
			model.addAttribute("errorMess", "serial name cannot be empty");
			return "add-book";
		}
		if (book.getName() == null || book.getName().isEmpty()) {
			model.addAttribute("errorMessa", "book name cannot be empty");
			return "add-book";
		}
